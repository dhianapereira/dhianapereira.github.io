...
gallery:
  ...
  - src: "/assets/images/projects/barba-e-tudo-app/barba-e-tudo-03.jpg"
    alt: "Tela de movimentações com abas de entradas e saídas, campo de busca, ação para nova entrada e cards de registros."
    caption: "A área de movimentações reúne entradas e saídas em uma leitura direta, com busca, ação rápida para novos lançamentos e cards que resumem cada registro."
  - src: "/assets/images/projects/barba-e-tudo-app/barba-e-tudo-04.jpg"
    alt: "Tela de movimentações no tema escuro com seletor de aparência aberto e lista de entradas."
    caption: "A mesma área de movimentações também mostra o cuidado com personalização visual, incluindo suporte a tema e consistência da leitura em diferentes modos de uso."
  - src: "/assets/images/projects/barba-e-tudo-app/barba-e-tudo-05.jpg"
    alt: "Tela de relatórios com filtros por perfil e período, campo de busca e botão para baixar PDF."
    caption: "Os relatórios transformam os dados da operação em consultas objetivas, com recortes por período, perfil acompanhado e exportação em PDF."
  - src: "/assets/images/projects/barba-e-tudo-app/barba-e-tudo-06.jpg"
    alt: "Tela de despesas com filtros por status, campo de busca, resumo de valores e estado vazio para novas despesas."
  ...
  - src: "/assets/images/projects/barba-e-tudo-app/barba-e-tudo-07.jpg"
    alt: "Tela de produtos com busca, filtros e cards mostrando status, quantidade em estoque e informações de precificação."
    caption: "O catálogo de produtos combina busca, filtros e cards detalhados para facilitar consultas rápidas sobre estoque, categoria e preços."
